...
public class excel2 {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		...
		FileInputStream sh= new FileInputStream("C:\\Users\\admin\\Desktop\\excel sheet\\Book1.xlsx");
		...
		int bookkk= (int) WorkbookFactory.create(sh).getSheet("Sheet2").getRow(0).getCell(1).getNumericCellValue();
